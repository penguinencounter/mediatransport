...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/mediatransport.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: mediatransport-common-common-refmap.json
        // fixed:   mediatransport-common.refmap.json
