...
abstract class MediaTransportModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<MediaTransportModDependenciesExtension>("mediatransportModDependencies")
